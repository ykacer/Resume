...
% Define color link
\definecolor{links_color}{HTML}{1A1B81}
...
\firstname{Youcef}
\familyname{Kacer}
\address{38 allée Darius Milhaud}{Paris 75019}
\mobile{+336 22 54 70 97}
\email{youcef.kacer@gmail.com}
\homepage{ykacer.github.io}
\social[github][github.com/ykacer]{github.com/ykacer}
\social[linkedin][www.linkedin.com/in/youcef-kacer-413412135]{youcef-kacer}

\extrainfo{nationality: French}
\photo[64pt][0.4pt]{ykacer.JPG}
%\quote{Aspiring to be the best}
\title{Curriculum Vitae}
\quote{Machine Learning \& Computer Vision Engineer}
...
\cvitem{Aug 2012 }{ \textbf{Machine Learning \& Computer Vision Engineer}, \textit{Smiths Detection, Vitry-sur-Seine, France.}}
\cvitem{to current}{
    Development of machine learning protoypes to classify, detect and localize threats in X-ray images.
    \begin{itemize}%
    \item Feature extraction using high-level descriptors (DoG, HoG, BoW, Wavelets).
    \item Develop feature engineering (PCA, NMF, KMeans, EM)
    \item Feature classification using non linear classifiers (SVM, KNN) and ensemble methods (Gradient Boosting, Random Forest).
    \item Implementation of deep learning methods to classify images (CNN) and localize threats or objects for recognition purpose (RCNN).
    \item High experience tuning classifiers hyperparameters.
    \item Mixing visual and semantic (Wordnet) information into Content-Based Image Retrieval system for cargo inspection purpose.
    \item Assisting software team for release implementations.
    \item Python (Scikit-Learn), Matlab (MatConvNet), C++ (STL, OpenCV, LibSVM), NVIDIA GPU.
    \end{itemize}
}

\cvitem{Aug 2011}{ \textbf{Machine Learning \& Computer Vision Engineer}, \textit{Thales C\&S, Velizy, France.}}
\cvitem{to Jul 2012}{
Development of machine learning functions on color images to analyse (colour, shape, license plate) and control vehicles at frontiers.
\begin{itemize}%
\item Localize vehicle using high level image processing (Hough transform).
\item Develop SIFT feature extractor for shape recognition.
\item Colour vehicle classfication using a derivation of PLSA datamining algorithm (Probabilistic Latent Semantic Analysis) and color hierarchical clustering (Mean-Shift algorithm).
\item C++ (STL, Boost, OpenCV), Matlab 
\end{itemize}
}

\cvitem{Jun 2009}{ \textbf{Signal Processing Engineer}, \textit{Thales Air Systems, Limours, France.}}
\cvitem{to Nov 2010}{
Development of a Matlab prototype function on ground pulse radar, to detect exact positions and speeds targets (solving well-known distance and speed ambiguities)
\begin{itemize}%
\item Clustering elementary detections using Hierarchical Ascendant Clustering with Ward distance.
\item Prune false alarm by satistics test (goodness-of-fit) on cluster compactness.
\item Using synthesized data for developement and fine-tuning parameters on ground-truth recordings to meet performance requirements (distance and angular target discrimination)
\item Assisting sofware team for release implementation and validation team for real time analysis.
\end{itemize}
}


\cvitem{Mar 2008}{ \textbf{Engineer Intern}, \textit{Dassault-Aviation, Saint-Cloud, France.}}
\cvitem{to Oct 2008}{
Prototype a Matlab antena mesh and simulate it to meet performance requirements (central frequency and bandwith, spatial directivity).
}
\cvitem{\linebreak}{}

\cvitem{July 2007}{ \textbf{Waiter}, \textit{Le Pain Quotidien, London, UK.}}
\cvitem{to Sept 2007}{
Work as a waiter during job summer.
}
\cvitem{\linebreak}{}

\section{Education} % =====================================

\cvitem{2016--2017}{ \textcolor{links_color}{\href{http://www.telecom-evolution.fr/fr/ces-data-scientist-data-science-analyse-et-gestion-de-grandes-masses-de-donnees}{\textbf{Data Scientist \& Big Data Certificate}}}, \textit{Telecom ParisTech }, France.}
\cvitem{}{
25-days professional courses to challenge extraction information from large scalable data. Follow \href{https://github.com/ykacer/CES_Data_Scientist_2016/}{\textbf{link}} for more details.
\begin{itemize}%
\item Vapnik-Chervonenkis theory for statistic learning (bias-variance trade-off)
\item Supervised/Unsupervised Learning
\item Markov Chains and Bayesian Networks
\item NoSQL database
\item Storage and Computation (Map/Reduce, PageRank) of distributed data
\item Data vizualisation
\item 4-months project to predict human density using high-resolution satellite images. Follow \href{https://github.com/ykacer/CES_Data_Scientist_2016/tree/master/25_projet_data_scientist}{\textbf{link}} for more details.
\end{itemize}
}

\cvitem{2016}{ \textcolor{links_color}{\href{https://openclassrooms.com/courses/administrez-vos-bases-de-donnees-avec-mysql}{\textbf{MySQL Online Certificate}}}, \textit{openclassrooms.com }, France.}
\cvitem{}{
Online professional certification to create, store, manage and query relational database with MySQL
\begin{itemize}%
\item Indexation, Keys, Jointures, Aggregation and grouping, Transactions, Procedures, Error handling, Triggers. 
Follow \href{https://github.com/ykacer/OPENCLASSROOMS_SGBD_Mysql_Program_2016}{\textbf{link}} for more details
\end{itemize}
}

\cvitem{2005--2008}{ \textbf{Msc in Mathematics \& Computer Science}, \textit{Telecom Bretagne }, France.}
\cvitem{}{
One of the leading Engineering School in France.
\begin{itemize}%
\item Deterministics signals and frequency analysis.
\item Random signals and statistics.
\item Image processing for computer vision.
\end{itemize}
}

\cvitem{2002--2005}{ \textbf{Scientific Preparatory Classes PCSI/PC*}, \textit{Lycée Fénelon}, France.}
\cvitem{}{
 Scientific preparation to the french Grandes Ecoles with competitive entrance examinations
}

\cvitem{1999--2002}{ \textbf{Scientific Baccalauréat with honors (French high-school degree)}, \textit{Lycée Hélène Boucher}, France.}
\cvitem{}{
}
...
% }
% \cvitem{}{
% Distributed Data Management Frameworks
% \begin{itemize}%
...
\cvitem{}{\textbf{Scientific Programming}}
\cvitem{}
{
...
\cvitem{}{\textbf{Machine Learning Frameworks}}
\cvitem{}
{
\hspace{10mm}\begin{tabular}{p{5cm}l}
...
\cvitem{}{\textbf{Distributed Data Frameworks}}
\cvitem{}
{
\hspace{10mm}\begin{tabular}{p{5cm}l}
...
\cvitem{}{\textbf{Database Management}}
\cvitem{}
{
\hspace{10mm}\begin{tabular}{p{5cm}l}
MySQL & $\star$ \\
...
\section{Interests} % =====================================
\cvitem{}{Traveling, daily fitness, cooking, French literature}
